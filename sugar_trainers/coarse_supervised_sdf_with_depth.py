...
def coarse_training_with_supervised_sdf_with_depth_regularization(args):
    ...
    sugar_checkpoint_path = f'sugarcoarse_3Dgs{iteration_to_load}_{args.strategy}_supervised_sdfestimXX_sdfnormYY/'
